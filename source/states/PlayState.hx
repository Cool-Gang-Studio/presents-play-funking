...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'stage': new states.stages.baseGame.StageWeek1(); //Week 1
			case 'spooky': new states.stages.baseGame.Spooky(); //Week 2
			case 'philly': new states.stages.baseGame.Philly(); //Week 3
			case 'limo': new states.stages.baseGame.Limo(); //Week 4
			case 'mall': new states.stages.baseGame.Mall(); //Week 5 - Cocoa, Eggnog
			case 'mallEvil': new states.stages.baseGame.MallEvil(); //Week 5 - Winter Horrorland
			case 'school': new states.stages.baseGame.School(); //Week 6 - Senpai, Roses
			case 'schoolEvil': new states.stages.baseGame.SchoolEvil(); //Week 6 - Thorns
			case 'tank': new states.stages.baseGame.Tank(); //Week 7 - Ugh, Guns, Stress
			case 'park': new states.stages.presents.Park(); // Presidental Rap
			case 'presents': new states.stages.presents.PresentsBG(); // Presents
		}
		...
		// put hardcoded video stuff here ig
	...
	public function startVideo(name:String #if desktop , ?skipKeys:Array<FlxKey> = null #end)
	{
		#if VIDEOS_ALLOWED
		inCutscene = true;
